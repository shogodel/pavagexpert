    ...
    <section className="py-12 md:py-16 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-stone-800">{t.title}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {articles.map((a) => (
            <Link
              ...
              className="bg-white rounded-xl p-6 border border-stone-200 hover:border-terracotta/30 transition-all shadow-sm hover:shadow-lg group"
            >
              <h3 className="font-heading font-semibold text-stone-800 group-hover:text-terracotta transition-colors mb-2">
                {a.title}
              </h3>
              <p className="text-sm text-stone-500 mb-3">{a.desc}</p>
